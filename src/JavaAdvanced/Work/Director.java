...
public class Director extends Employee{
    ...
    public Director(String name, int age, String sex, float salary, float baseSalary, String salaryRate, int numberOfSubordinates) {
    ...
    public Float getSalary() {
        if (this.numberOfSubordinates.equals(0)) {
            ...
            return this.getBaseSalary() * (this.numberOfSubordinates / 100F * 9F);
        }
    }
}
